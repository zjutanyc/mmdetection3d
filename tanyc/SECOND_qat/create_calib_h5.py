...
Usage:
  python tanyc/SECOND_qat/create_calib_h5.py \
    ...
    --checkpoint tanyc/SECOND_qat/pretrained/second_hv_secfpn_8xb6-80e_kitti-3d-car-75d9305e.pth \
    --work-dir work_dirs/mmdeploy/second_trt_int8 \
    --device cuda:0
"""
...
def parse_args():
    ...
    parser.add_argument('--checkpoint',
                        default='tanyc/SECOND_qat/pretrained/hv_second_secfpn_6x8_80e_kitti-3d-car_20200620_230238-393f000c.pth')
    parser.add_argument('--work-dir', default='work_dirs/mmdeploy/second_trt_int8')
